...
EOT;
	...
	{
		$raw_places = Places_List::get(array('version', 'list'));
	...
	public function create_list()
	{
		...
		else
		{
			...
			$places_list = Places_List::where('hash', '=', $places_hashed)->first();
			$new_list = new Places_List;
			...
			{
				$last_version = Places_List::order_by('id', 'desc')->take(1)->only('version');
